...
## If using ChatGPT, update the api_key with your openAI api key. Then change the function name from ask_chatgpt_obsolete to ask_chatgpt. Similarly, rename the
## 2nd function below from ask_chatgpt to ask_chatgpt_obsolete if you are using Locally running LLMs
